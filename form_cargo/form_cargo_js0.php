<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idcargo_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idcargo_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_cargo"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_cargo_submit_form(y, z); 
} 
<?php
}
?>
