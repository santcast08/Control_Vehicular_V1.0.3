  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cargo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cargo_descripcion_
  function do_ajax_form_cargo_validate_cargo_descripcion_(iNumLinha)
  {
    var nomeCampo_cargo_descripcion_ = "cargo_descripcion_" + iNumLinha;
    var var_cargo_descripcion_ = scAjaxGetFieldText(nomeCampo_cargo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cargo_validate_cargo_descripcion_(var_cargo_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_cargo_validate_cargo_descripcion__cb);
  } // do_ajax_form_cargo_validate_cargo_descripcion_

  function do_ajax_form_cargo_validate_cargo_descripcion__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "cargo_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cargo_descripcion_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "cargo_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cargo_descripcion_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cargo_validate_cargo_descripcion__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cargo_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cargo_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cargo_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cargo_add_new_line_cb);
  } // do_ajax_form_cargo_add_new_line

  function do_ajax_form_cargo_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cargo_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cargo_backup_line(iNumLinha)
  {
    var var_idcargo_ = scAjaxGetFieldText("idcargo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cargo_backup_line(var_idcargo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cargo_backup_line_cb);
  } // do_ajax_form_cargo_backup_line

  function do_ajax_form_cargo_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cargo_backup_line_cb

  function do_ajax_form_cargo_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cargo_cancel_insert

  function do_ajax_form_cargo_cancel_update(iSeqVert)
  {
    do_ajax_form_cargo_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cargo_cancel_update

  function do_ajax_form_cargo_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cargo_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cargo_table_refresh()
  {
    var var_idcargo_ = document.F2.idcargo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cargo_table_refresh(var_idcargo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cargo_table_refresh_cb);
  } //  do_ajax_form_cargo_table_refresh

  function do_ajax_form_cargo_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcargo_.value = scAjaxGetKeyValue("idcargo_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_cargo_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cargo_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cargo_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_cargo_descripcion_ = scAjaxGetFieldText("cargo_descripcion_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_cargo_submit_form(var_cargo_descripcion_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cargo_submit_form_cb);
  } // do_ajax_form_cargo_submit_form

  function do_ajax_form_cargo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cargo_descripcion_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
  ...
  } // do_ajax_form_cargo_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_cargo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_cargo_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("cargo_descripcion_" + iNavForm);
    }
    var var_idcargo_ = document.F2.idcargo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cargo_navigate_form(var_idcargo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cargo_navigate_form_cb);
  } // do_ajax_form_cargo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cargo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cargo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcargo_.value = scAjaxGetKeyValue("idcargo_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_cargo_navigate_form_cb
  function sc_hide_form_cargo_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_cargo_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "cargo_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["cargo_descripcion_" + iNumLinha] = {"label": "Cargo Descripcion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["cargo_descripcion_"][iNumLinha] = "cargo_descripcion_" + iNumLinha;
    ajax_field_id["cargo_descripcion_" + iNumLinha] = new Array("hidden_field_label_cargo_descripcion_", "hidden_field_data_cargo_descripcion_" + iNumLinha);
    ajax_error_count["cargo_descripcion_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["cargo_descripcion_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["cargo_descripcion_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["cargo_descripcion_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["cargo_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cargo_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cargo_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cargo_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cargo_descripcion_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cargo_descripcion_'])) ? $this->nmgp_cmp_readonly['cargo_descripcion_'] : 'off';
?>
    scAjaxFieldRead("cargo_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("cargo_descripcion_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["cargo_descripcion_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cargo_descripcion_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["cargo_descripcion_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["cargo_descripcion_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_cargo_descripcion_" + iRow).removeClass("scFormErrorLine");
    }
  }
