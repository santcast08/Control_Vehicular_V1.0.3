  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_asignar_vehiculo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_asignar_vehiculo_validate_asignar_vehiculo_fecha()
  {
    ...
    setTimeout(function() { x_ajax_form_asignar_vehiculo_validate_asignar_vehiculo_fecha(var_asignar_vehiculo_fecha, var_script_case_init, do_ajax_form_asignar_vehiculo_validate_asignar_vehiculo_fecha_cb); }, 200);
  } // do_ajax_form_asignar_vehiculo_validate_asignar_vehiculo_fecha

  function do_ajax_form_asignar_vehiculo_validate_asignar_vehiculo_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignar_vehiculo_validate_asignar_vehiculo_fecha_cb

  // ---------- Validate usuario_idusuario
  function do_ajax_form_asignar_vehiculo_validate_usuario_idusuario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignar_vehiculo_validate_usuario_idusuario(var_usuario_idusuario, var_script_case_init, do_ajax_form_asignar_vehiculo_validate_usuario_idusuario_cb);
  } // do_ajax_form_asignar_vehiculo_validate_usuario_idusuario

  function do_ajax_form_asignar_vehiculo_validate_usuario_idusuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignar_vehiculo_validate_usuario_idusuario_cb

  // ---------- Validate idasignar_vehiculo
  function do_ajax_form_asignar_vehiculo_validate_idasignar_vehiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignar_vehiculo_validate_idasignar_vehiculo(var_idasignar_vehiculo, var_script_case_init, do_ajax_form_asignar_vehiculo_validate_idasignar_vehiculo_cb);
  } // do_ajax_form_asignar_vehiculo_validate_idasignar_vehiculo

  function do_ajax_form_asignar_vehiculo_validate_idasignar_vehiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignar_vehiculo_validate_idasignar_vehiculo_cb
  // ---------- Form
  function do_ajax_form_asignar_vehiculo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_asignar_vehiculo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_asignar_vehiculo_submit_form(var_asignar_vehiculo_fecha, var_usuario_idusuario, var_idasignar_vehiculo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_asignar_vehiculo_submit_form_cb);
  } // do_ajax_form_asignar_vehiculo_submit_form

  function do_ajax_form_asignar_vehiculo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_asignar_vehiculo_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_asignar_vehiculo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_asignar_vehiculo_navigate_form(var_idasignar_vehiculo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_asignar_vehiculo_navigate_form_cb);
  } // do_ajax_form_asignar_vehiculo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_asignar_vehiculo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_asignar_vehiculo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_asignar_vehiculo_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_asignar_vehiculo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_asignar_vehiculo_navigate_form_cb
  function sc_hide_form_asignar_vehiculo_form()
  {
