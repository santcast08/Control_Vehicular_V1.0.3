  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_asignar_vehiculo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate asignar_vehiculo_fecha
  function do_ajax_form_asignar_vehiculo_mob_validate_asignar_vehiculo_fecha()
  {
    var nomeCampo_asignar_vehiculo_fecha = "asignar_vehiculo_fecha";
    var var_asignar_vehiculo_fecha = scAjaxGetFieldText(nomeCampo_asignar_vehiculo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_form_asignar_vehiculo_mob_validate_asignar_vehiculo_fecha(var_asignar_vehiculo_fecha, var_script_case_init, do_ajax_form_asignar_vehiculo_mob_validate_asignar_vehiculo_fecha_cb); }, 200);
  } // do_ajax_form_asignar_vehiculo_mob_validate_asignar_vehiculo_fecha

  function do_ajax_form_asignar_vehiculo_mob_validate_asignar_vehiculo_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asignar_vehiculo_fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignar_vehiculo_mob_validate_asignar_vehiculo_fecha_cb

  // ---------- Validate usuario_idusuario
  function do_ajax_form_asignar_vehiculo_mob_validate_usuario_idusuario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignar_vehiculo_mob_validate_usuario_idusuario(var_usuario_idusuario, var_script_case_init, do_ajax_form_asignar_vehiculo_mob_validate_usuario_idusuario_cb);
  } // do_ajax_form_asignar_vehiculo_mob_validate_usuario_idusuario

  function do_ajax_form_asignar_vehiculo_mob_validate_usuario_idusuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignar_vehiculo_mob_validate_usuario_idusuario_cb

  // ---------- Validate idasignar_vehiculo
  function do_ajax_form_asignar_vehiculo_mob_validate_idasignar_vehiculo()
  {
    var nomeCampo_idasignar_vehiculo = "idasignar_vehiculo";
    var var_idasignar_vehiculo = scAjaxGetFieldHidden(nomeCampo_idasignar_vehiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignar_vehiculo_mob_validate_idasignar_vehiculo(var_idasignar_vehiculo, var_script_case_init, do_ajax_form_asignar_vehiculo_mob_validate_idasignar_vehiculo_cb);
  } // do_ajax_form_asignar_vehiculo_mob_validate_idasignar_vehiculo

  function do_ajax_form_asignar_vehiculo_mob_validate_idasignar_vehiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idasignar_vehiculo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignar_vehiculo_mob_validate_idasignar_vehiculo_cb
  // ---------- Form
  function do_ajax_form_asignar_vehiculo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_asignar_vehiculo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_asignar_vehiculo_fecha = scAjaxGetFieldText("asignar_vehiculo_fecha");
    var var_usuario_idusuario = scAjaxGetFieldSelect("usuario_idusuario");
    var var_idasignar_vehiculo = scAjaxGetFieldHidden("idasignar_vehiculo");
    ...
    scAjaxProcOn();
    x_ajax_form_asignar_vehiculo_mob_submit_form(var_asignar_vehiculo_fecha, var_usuario_idusuario, var_idasignar_vehiculo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_asignar_vehiculo_mob_submit_form_cb);
  } // do_ajax_form_asignar_vehiculo_mob_submit_form

  function do_ajax_form_asignar_vehiculo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("asignar_vehiculo_fecha");
      scAjaxHideErrorDisplay("usuario_idusuario");
      scAjaxHideErrorDisplay("idasignar_vehiculo");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_asignar_vehiculo_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_asignar_vehiculo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("usuario_idusuario");
    scAjaxHideErrorDisplay("idasignar_vehiculo");
    var var_idasignar_vehiculo = document.F2.idasignar_vehiculo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_asignar_vehiculo_mob_navigate_form(var_idasignar_vehiculo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_asignar_vehiculo_mob_navigate_form_cb);
  } // do_ajax_form_asignar_vehiculo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_asignar_vehiculo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_asignar_vehiculo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_asignar_vehiculo_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idasignar_vehiculo.value = scAjaxGetKeyValue("idasignar_vehiculo");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_asignar_vehiculo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_asignar_vehiculo_mob_navigate_form_cb
  function sc_hide_form_asignar_vehiculo_mob_form()
  {
  ...
  ajax_field_list[0] = "asignar_vehiculo_fecha";
  ajax_field_list[1] = "usuario_idusuario";
  ajax_field_list[2] = "idasignar_vehiculo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "asignar_vehiculo_fecha": {"label": "Asignar Vehiculo Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_idusuario": {"label": "Usuario Idusuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idasignar_vehiculo": {"label": "Id Asignar Vehiculo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "asignar_vehiculo_fecha": new Array(),
    "usuario_idusuario": new Array(),
    "idasignar_vehiculo": new Array()
  };
  ajax_field_mult["asignar_vehiculo_fecha"][1] = "asignar_vehiculo_fecha";
  ajax_field_mult["usuario_idusuario"][1] = "usuario_idusuario";
  ajax_field_mult["idasignar_vehiculo"][1] = "idasignar_vehiculo";

  var ajax_field_id = {
    "asignar_vehiculo_fecha": new Array("hidden_field_label_asignar_vehiculo_fecha", "hidden_field_data_asignar_vehiculo_fecha"),
    "usuario_idusuario": new Array("hidden_field_label_usuario_idusuario", "hidden_field_data_usuario_idusuario"),
    "idasignar_vehiculo": new Array("hidden_field_label_idasignar_vehiculo", "hidden_field_data_idasignar_vehiculo")
  };

  var ajax_read_only = {
    "asignar_vehiculo_fecha": "off",
    "usuario_idusuario": "off",
    "idasignar_vehiculo": "on"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("asignar_vehiculo_fecha" == sIndex)
    {
