...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Control_Vehicular_____form_funcionario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Control_Vehicular_____form_funcionario"]);
   }
