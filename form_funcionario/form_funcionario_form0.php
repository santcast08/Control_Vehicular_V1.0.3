...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usuario_cedula_label" id="hidden_field_label_usuario_cedula" style="<?php echo $sStyleHidden_usuario_cedula; ?>"><span id="id_label_usuario_cedula"><?php echo $this->nm_new_label['usuario_cedula']; ?></span></TD>
    <TD class="scFormDataOdd css_usuario_cedula_line" id="hidden_field_data_usuario_cedula" style="<?php echo $sStyleHidden_usuario_cedula; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_cedula_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usuario_nombres_label" id="hidden_field_label_usuario_nombres" style="<?php echo $sStyleHidden_usuario_nombres; ?>"><span id="id_label_usuario_nombres"><?php echo $this->nm_new_label['usuario_nombres']; ?></span></TD>
    <TD class="scFormDataOdd css_usuario_nombres_line" id="hidden_field_data_usuario_nombres" style="<?php echo $sStyleHidden_usuario_nombres; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_nombres_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usuario_apellidos_label" id="hidden_field_label_usuario_apellidos" style="<?php echo $sStyleHidden_usuario_apellidos; ?>"><span id="id_label_usuario_apellidos"><?php echo $this->nm_new_label['usuario_apellidos']; ?></span></TD>
    <TD class="scFormDataOdd css_usuario_apellidos_line" id="hidden_field_data_usuario_apellidos" style="<?php echo $sStyleHidden_usuario_apellidos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_apellidos_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usuario_cargo_label" id="hidden_field_label_usuario_cargo" style="<?php echo $sStyleHidden_usuario_cargo; ?>"><span id="id_label_usuario_cargo"><?php echo $this->nm_new_label['usuario_cargo']; ?></span></TD>
    <TD class="scFormDataOdd css_usuario_cargo_line" id="hidden_field_data_usuario_cargo" style="<?php echo $sStyleHidden_usuario_cargo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_cargo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usuario_dependencia_label" id="hidden_field_label_usuario_dependencia" style="<?php echo $sStyleHidden_usuario_dependencia; ?>"><span id="id_label_usuario_dependencia"><?php echo $this->nm_new_label['usuario_dependencia']; ?></span></TD>
    <TD class="scFormDataOdd css_usuario_dependencia_line" id="hidden_field_data_usuario_dependencia" style="<?php echo $sStyleHidden_usuario_dependencia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_dependencia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usuario_estado_label" id="hidden_field_label_usuario_estado" style="<?php echo $sStyleHidden_usuario_estado; ?>"><span id="id_label_usuario_estado"><?php echo $this->nm_new_label['usuario_estado']; ?></span></TD>
    <TD class="scFormDataOdd css_usuario_estado_line" id="hidden_field_data_usuario_estado" style="<?php echo $sStyleHidden_usuario_estado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_estado_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_estado'][] = 'ACTIVO'; ?>
 <option  value="INACTIVO" <?php  if ($this->usuario_estado == "INACTIVO") { echo " selected" ;} ?>>INACTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_estado'][] = 'INACTIVO'; ?>
 </select></span>
</span><?php  }?>
