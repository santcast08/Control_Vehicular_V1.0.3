...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate usuario_cedula
  function do_ajax_form_funcionario_validate_usuario_cedula()
  {
    var nomeCampo_usuario_cedula = "usuario_cedula";
    var var_usuario_cedula = scAjaxGetFieldText(nomeCampo_usuario_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_usuario_cedula(var_usuario_cedula, var_script_case_init, do_ajax_form_funcionario_validate_usuario_cedula_cb);
  } // do_ajax_form_funcionario_validate_usuario_cedula

  function do_ajax_form_funcionario_validate_usuario_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_cedula";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_usuario_cedula_cb

  // ---------- Validate usuario_nombres
  function do_ajax_form_funcionario_validate_usuario_nombres()
  {
    var nomeCampo_usuario_nombres = "usuario_nombres";
    var var_usuario_nombres = scAjaxGetFieldText(nomeCampo_usuario_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_usuario_nombres(var_usuario_nombres, var_script_case_init, do_ajax_form_funcionario_validate_usuario_nombres_cb);
  } // do_ajax_form_funcionario_validate_usuario_nombres

  function do_ajax_form_funcionario_validate_usuario_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_nombres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_usuario_nombres_cb

  // ---------- Validate usuario_apellidos
  function do_ajax_form_funcionario_validate_usuario_apellidos()
  {
    var nomeCampo_usuario_apellidos = "usuario_apellidos";
    var var_usuario_apellidos = scAjaxGetFieldText(nomeCampo_usuario_apellidos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_usuario_apellidos(var_usuario_apellidos, var_script_case_init, do_ajax_form_funcionario_validate_usuario_apellidos_cb);
  } // do_ajax_form_funcionario_validate_usuario_apellidos

  function do_ajax_form_funcionario_validate_usuario_apellidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_apellidos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_usuario_apellidos_cb

  // ---------- Validate usuario_correo
  function do_ajax_form_funcionario_validate_usuario_correo()
  {
    var nomeCampo_usuario_correo = "usuario_correo";
    var var_usuario_correo = scAjaxGetFieldText(nomeCampo_usuario_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_usuario_correo(var_usuario_correo, var_script_case_init, do_ajax_form_funcionario_validate_usuario_correo_cb);
  } // do_ajax_form_funcionario_validate_usuario_correo

  function do_ajax_form_funcionario_validate_usuario_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_usuario_correo_cb

  // ---------- Validate usuario_cargo
  function do_ajax_form_funcionario_validate_usuario_cargo()
  {
    var nomeCampo_usuario_cargo = "usuario_cargo";
    var var_usuario_cargo = scAjaxGetFieldSelect(nomeCampo_usuario_cargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_usuario_cargo(var_usuario_cargo, var_script_case_init, do_ajax_form_funcionario_validate_usuario_cargo_cb);
  } // do_ajax_form_funcionario_validate_usuario_cargo

  function do_ajax_form_funcionario_validate_usuario_cargo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_cargo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_usuario_cargo_cb

  // ---------- Validate usuario_dependencia
  function do_ajax_form_funcionario_validate_usuario_dependencia()
  {
    var nomeCampo_usuario_dependencia = "usuario_dependencia";
    var var_usuario_dependencia = scAjaxGetFieldSelect(nomeCampo_usuario_dependencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_usuario_dependencia(var_usuario_dependencia, var_script_case_init, do_ajax_form_funcionario_validate_usuario_dependencia_cb);
  } // do_ajax_form_funcionario_validate_usuario_dependencia

  function do_ajax_form_funcionario_validate_usuario_dependencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_dependencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_usuario_dependencia_cb

  // ---------- Validate usuario_estado
  function do_ajax_form_funcionario_validate_usuario_estado()
  {
    var nomeCampo_usuario_estado = "usuario_estado";
    var var_usuario_estado = scAjaxGetFieldSelect(nomeCampo_usuario_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_usuario_estado(var_usuario_estado, var_script_case_init, do_ajax_form_funcionario_validate_usuario_estado_cb);
  } // do_ajax_form_funcionario_validate_usuario_estado

  function do_ajax_form_funcionario_validate_usuario_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_usuario_estado_cb
  // ---------- Form
  function do_ajax_form_funcionario_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_usuario_cedula = scAjaxGetFieldText("usuario_cedula");
    var var_usuario_nombres = scAjaxGetFieldText("usuario_nombres");
    var var_usuario_apellidos = scAjaxGetFieldText("usuario_apellidos");
    var var_usuario_correo = scAjaxGetFieldText("usuario_correo");
    var var_usuario_cargo = scAjaxGetFieldSelect("usuario_cargo");
    var var_usuario_dependencia = scAjaxGetFieldSelect("usuario_dependencia");
    var var_usuario_estado = scAjaxGetFieldSelect("usuario_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_funcionario_submit_form(var_usuario_cedula, var_usuario_nombres, var_usuario_apellidos, var_usuario_correo, var_usuario_cargo, var_usuario_dependencia, var_usuario_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_funcionario_submit_form_cb);
  ...
  function do_ajax_form_funcionario_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("usuario_cedula");
      scAjaxHideErrorDisplay("usuario_nombres");
      scAjaxHideErrorDisplay("usuario_apellidos");
      scAjaxHideErrorDisplay("usuario_correo");
      scAjaxHideErrorDisplay("usuario_cargo");
      scAjaxHideErrorDisplay("usuario_dependencia");
      scAjaxHideErrorDisplay("usuario_estado");
      scLigEditLookupCall();
<?php
...
?>
  ...
  function do_ajax_form_funcionario_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("usuario_dependencia");
    scAjaxHideErrorDisplay("usuario_estado");
    var var_idusuario = document.F2.idusuario.value;
    ...
    scAjaxProcOn();
    x_ajax_form_funcionario_navigate_form(var_idusuario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionario_navigate_form_cb);
...
?>
  function do_ajax_form_funcionario_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idusuario.value = scAjaxGetKeyValue("idusuario");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
?>
  ...
  ajax_field_list[0] = "usuario_cedula";
  ajax_field_list[1] = "usuario_nombres";
  ajax_field_list[2] = "usuario_apellidos";
  ajax_field_list[3] = "usuario_correo";
  ajax_field_list[4] = "usuario_cargo";
  ajax_field_list[5] = "usuario_dependencia";
  ajax_field_list[6] = "usuario_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "usuario_cedula": {"label": "Cedula", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_nombres": {"label": "Nombres", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_apellidos": {"label": "Apellidos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_correo": {"label": "Correo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_cargo": {"label": "Cargo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_dependencia": {"label": "Dependencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_estado": {"label": "Estado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "usuario_cedula": new Array(),
    "usuario_nombres": new Array(),
    "usuario_apellidos": new Array(),
    "usuario_correo": new Array(),
    "usuario_cargo": new Array(),
    "usuario_dependencia": new Array(),
    "usuario_estado": new Array()
  };
  ajax_field_mult["usuario_cedula"][1] = "usuario_cedula";
  ajax_field_mult["usuario_nombres"][1] = "usuario_nombres";
  ajax_field_mult["usuario_apellidos"][1] = "usuario_apellidos";
  ajax_field_mult["usuario_correo"][1] = "usuario_correo";
  ajax_field_mult["usuario_cargo"][1] = "usuario_cargo";
  ajax_field_mult["usuario_dependencia"][1] = "usuario_dependencia";
  ajax_field_mult["usuario_estado"][1] = "usuario_estado";

  var ajax_field_id = {
    "usuario_cedula": new Array("hidden_field_label_usuario_cedula", "hidden_field_data_usuario_cedula"),
    "usuario_nombres": new Array("hidden_field_label_usuario_nombres", "hidden_field_data_usuario_nombres"),
    "usuario_apellidos": new Array("hidden_field_label_usuario_apellidos", "hidden_field_data_usuario_apellidos"),
    "usuario_correo": new Array("hidden_field_label_usuario_correo", "hidden_field_data_usuario_correo"),
    "usuario_cargo": new Array("hidden_field_label_usuario_cargo", "hidden_field_data_usuario_cargo"),
    "usuario_dependencia": new Array("hidden_field_label_usuario_dependencia", "hidden_field_data_usuario_dependencia"),
    "usuario_estado": new Array("hidden_field_label_usuario_estado", "hidden_field_data_usuario_estado")
  };

  var ajax_read_only = {
    "usuario_cedula": "off",
    "usuario_nombres": "off",
    "usuario_apellidos": "off",
    "usuario_correo": "off",
    "usuario_cargo": "off",
    "usuario_dependencia": "off",
    "usuario_estado": "off"
  };
