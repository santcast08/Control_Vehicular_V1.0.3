...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_funcionario_mob_validate_usuario_cedula()
  {
    var nomeCampo_usuario_cedula = "usuario_cedula";
    var var_usuario_cedula = scAjaxGetFieldText(nomeCampo_usuario_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_usuario_cedula(var_usuario_cedula, var_script_case_init, do_ajax_form_funcionario_mob_validate_usuario_cedula_cb);
  } // do_ajax_form_funcionario_mob_validate_usuario_cedula

  function do_ajax_form_funcionario_mob_validate_usuario_cedula_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_usuario_cedula_cb

  // ---------- Validate usuario_nombres
  function do_ajax_form_funcionario_mob_validate_usuario_nombres()
  {
    var nomeCampo_usuario_nombres = "usuario_nombres";
    var var_usuario_nombres = scAjaxGetFieldText(nomeCampo_usuario_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_usuario_nombres(var_usuario_nombres, var_script_case_init, do_ajax_form_funcionario_mob_validate_usuario_nombres_cb);
  } // do_ajax_form_funcionario_mob_validate_usuario_nombres

  function do_ajax_form_funcionario_mob_validate_usuario_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_usuario_nombres_cb

  // ---------- Validate usuario_apellidos
  function do_ajax_form_funcionario_mob_validate_usuario_apellidos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_usuario_apellidos(var_usuario_apellidos, var_script_case_init, do_ajax_form_funcionario_mob_validate_usuario_apellidos_cb);
  } // do_ajax_form_funcionario_mob_validate_usuario_apellidos

  function do_ajax_form_funcionario_mob_validate_usuario_apellidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_usuario_apellidos_cb

  // ---------- Validate usuario_correo
  function do_ajax_form_funcionario_mob_validate_usuario_correo()
  {
    var nomeCampo_usuario_correo = "usuario_correo";
    var var_usuario_correo = scAjaxGetFieldText(nomeCampo_usuario_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_usuario_correo(var_usuario_correo, var_script_case_init, do_ajax_form_funcionario_mob_validate_usuario_correo_cb);
  } // do_ajax_form_funcionario_mob_validate_usuario_correo

  function do_ajax_form_funcionario_mob_validate_usuario_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_usuario_correo_cb

  // ---------- Validate usuario_cargo
  function do_ajax_form_funcionario_mob_validate_usuario_cargo()
  {
    var nomeCampo_usuario_cargo = "usuario_cargo";
    var var_usuario_cargo = scAjaxGetFieldSelect(nomeCampo_usuario_cargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_usuario_cargo(var_usuario_cargo, var_script_case_init, do_ajax_form_funcionario_mob_validate_usuario_cargo_cb);
  } // do_ajax_form_funcionario_mob_validate_usuario_cargo

  function do_ajax_form_funcionario_mob_validate_usuario_cargo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_usuario_cargo_cb

  // ---------- Validate usuario_dependencia
  function do_ajax_form_funcionario_mob_validate_usuario_dependencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_usuario_dependencia(var_usuario_dependencia, var_script_case_init, do_ajax_form_funcionario_mob_validate_usuario_dependencia_cb);
  } // do_ajax_form_funcionario_mob_validate_usuario_dependencia

  function do_ajax_form_funcionario_mob_validate_usuario_dependencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_usuario_dependencia_cb

  // ---------- Validate usuario_estado
  function do_ajax_form_funcionario_mob_validate_usuario_estado()
  {
    var nomeCampo_usuario_estado = "usuario_estado";
    var var_usuario_estado = scAjaxGetFieldSelect(nomeCampo_usuario_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_usuario_estado(var_usuario_estado, var_script_case_init, do_ajax_form_funcionario_mob_validate_usuario_estado_cb);
  } // do_ajax_form_funcionario_mob_validate_usuario_estado

  function do_ajax_form_funcionario_mob_validate_usuario_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_usuario_estado_cb
  // ---------- Form
  function do_ajax_form_funcionario_mob_submit_form()
  {
    ...
    var var_idusuario = scAjaxGetFieldText("idusuario");
    ...
    scAjaxProcOn();
    x_ajax_form_funcionario_mob_submit_form(var_usuario_cedula, var_usuario_nombres, var_usuario_apellidos, var_usuario_correo, var_usuario_cargo, var_usuario_dependencia, var_usuario_estado, var_idusuario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_funcionario_mob_submit_form_cb);
...
?>
  ...
  function do_ajax_form_funcionario_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_funcionario_mob_navigate_form(var_idusuario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionario_mob_navigate_form_cb);
