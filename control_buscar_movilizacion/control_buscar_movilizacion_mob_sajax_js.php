  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_buscar_movilizacion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate buscar_vehiculo_movilizacion
  function do_ajax_control_buscar_movilizacion_mob_validate_buscar_vehiculo_movilizacion()
  {
    var nomeCampo_buscar_vehiculo_movilizacion = "buscar_vehiculo_movilizacion";
    var var_buscar_vehiculo_movilizacion = scAjaxGetFieldSelect(nomeCampo_buscar_vehiculo_movilizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_buscar_movilizacion_mob_validate_buscar_vehiculo_movilizacion(var_buscar_vehiculo_movilizacion, var_script_case_init, do_ajax_control_buscar_movilizacion_mob_validate_buscar_vehiculo_movilizacion_cb);
  } // do_ajax_control_buscar_movilizacion_mob_validate_buscar_vehiculo_movilizacion

  function do_ajax_control_buscar_movilizacion_mob_validate_buscar_vehiculo_movilizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "buscar_vehiculo_movilizacion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_buscar_movilizacion_mob_validate_buscar_vehiculo_movilizacion_cb

  // ---------- Validate buscar_fecha_inicio_movilizacion
  function do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_inicio_movilizacion()
  {
    var nomeCampo_buscar_fecha_inicio_movilizacion = "buscar_fecha_inicio_movilizacion";
    var var_buscar_fecha_inicio_movilizacion = scAjaxGetFieldText(nomeCampo_buscar_fecha_inicio_movilizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_inicio_movilizacion(var_buscar_fecha_inicio_movilizacion, var_script_case_init, do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_inicio_movilizacion_cb); }, 200);
  } // do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_inicio_movilizacion

  function do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_inicio_movilizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "buscar_fecha_inicio_movilizacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_inicio_movilizacion_cb

  // ---------- Validate buscar_fecha_fin_movilizacion
  function do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_fin_movilizacion()
  {
    var nomeCampo_buscar_fecha_fin_movilizacion = "buscar_fecha_fin_movilizacion";
    var var_buscar_fecha_fin_movilizacion = scAjaxGetFieldText(nomeCampo_buscar_fecha_fin_movilizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_fin_movilizacion(var_buscar_fecha_fin_movilizacion, var_script_case_init, do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_fin_movilizacion_cb); }, 200);
  } // do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_fin_movilizacion

  function do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_fin_movilizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "buscar_fecha_fin_movilizacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_buscar_movilizacion_mob_validate_buscar_fecha_fin_movilizacion_cb
  // ---------- Form
  function do_ajax_control_buscar_movilizacion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_buscar_movilizacion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_buscar_vehiculo_movilizacion = scAjaxGetFieldSelect("buscar_vehiculo_movilizacion");
    var var_buscar_fecha_inicio_movilizacion = scAjaxGetFieldText("buscar_fecha_inicio_movilizacion");
    var var_buscar_fecha_fin_movilizacion = scAjaxGetFieldText("buscar_fecha_fin_movilizacion");
    ...
    scAjaxProcOn();
    x_ajax_control_buscar_movilizacion_mob_submit_form(var_buscar_vehiculo_movilizacion, var_buscar_fecha_inicio_movilizacion, var_buscar_fecha_fin_movilizacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_buscar_movilizacion_mob_submit_form_cb);
  } // do_ajax_control_buscar_movilizacion_mob_submit_form

  function do_ajax_control_buscar_movilizacion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_control_buscar_movilizacion_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_buscar_movilizacion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_buscar_movilizacion_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_buscar_movilizacion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_buscar_movilizacion_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_control_buscar_movilizacion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_buscar_movilizacion_mob_navigate_form_cb
  function sc_hide_control_buscar_movilizacion_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_buscar_movilizacion_mob_form
  ...
  ajax_field_list[0] = "buscar_vehiculo_movilizacion";
  ajax_field_list[1] = "buscar_fecha_inicio_movilizacion";
  ajax_field_list[2] = "buscar_fecha_fin_movilizacion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "buscar_vehiculo_movilizacion": {"label": "Vehículo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "buscar_fecha_inicio_movilizacion": {"label": "Fecha:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "buscar_fecha_fin_movilizacion": {"label": "Hasta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "buscar_vehiculo_movilizacion": new Array(),
    "buscar_fecha_inicio_movilizacion": new Array(),
    "buscar_fecha_fin_movilizacion": new Array()
  };
  ajax_field_mult["buscar_vehiculo_movilizacion"][1] = "buscar_vehiculo_movilizacion";
  ajax_field_mult["buscar_fecha_inicio_movilizacion"][1] = "buscar_fecha_inicio_movilizacion";
  ajax_field_mult["buscar_fecha_fin_movilizacion"][1] = "buscar_fecha_fin_movilizacion";

  var ajax_field_id = {
    "buscar_vehiculo_movilizacion": new Array("hidden_field_label_buscar_vehiculo_movilizacion", "hidden_field_data_buscar_vehiculo_movilizacion"),
    "buscar_fecha_inicio_movilizacion": new Array("hidden_field_label_buscar_fecha_inicio_movilizacion", "hidden_field_data_buscar_fecha_inicio_movilizacion"),
    "buscar_fecha_fin_movilizacion": new Array("hidden_field_label_buscar_fecha_fin_movilizacion", "hidden_field_data_buscar_fecha_fin_movilizacion")
  };

  var ajax_read_only = {
    "buscar_vehiculo_movilizacion": "off",
    "buscar_fecha_inicio_movilizacion": "off",
    "buscar_fecha_fin_movilizacion": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("buscar_vehiculo_movilizacion" == sIndex)
    {
    ...
    if ("buscar_fecha_inicio_movilizacion" == sIndex)
    {
    ...
    if ("buscar_fecha_fin_movilizacion" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
