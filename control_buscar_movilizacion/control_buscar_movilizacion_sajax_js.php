  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_buscar_movilizacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_control_buscar_movilizacion_validate_buscar_vehiculo_movilizacion()
  {
    ...
    x_ajax_control_buscar_movilizacion_validate_buscar_vehiculo_movilizacion(var_buscar_vehiculo_movilizacion, var_script_case_init, do_ajax_control_buscar_movilizacion_validate_buscar_vehiculo_movilizacion_cb);
  } // do_ajax_control_buscar_movilizacion_validate_buscar_vehiculo_movilizacion

  function do_ajax_control_buscar_movilizacion_validate_buscar_vehiculo_movilizacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_buscar_movilizacion_validate_buscar_vehiculo_movilizacion_cb

  // ---------- Validate buscar_fecha_inicio_movilizacion
  function do_ajax_control_buscar_movilizacion_validate_buscar_fecha_inicio_movilizacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_control_buscar_movilizacion_validate_buscar_fecha_inicio_movilizacion(var_buscar_fecha_inicio_movilizacion, var_script_case_init, do_ajax_control_buscar_movilizacion_validate_buscar_fecha_inicio_movilizacion_cb); }, 200);
  } // do_ajax_control_buscar_movilizacion_validate_buscar_fecha_inicio_movilizacion

  function do_ajax_control_buscar_movilizacion_validate_buscar_fecha_inicio_movilizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_buscar_movilizacion_validate_buscar_fecha_inicio_movilizacion_cb

  // ---------- Validate buscar_fecha_fin_movilizacion
  function do_ajax_control_buscar_movilizacion_validate_buscar_fecha_fin_movilizacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_control_buscar_movilizacion_validate_buscar_fecha_fin_movilizacion(var_buscar_fecha_fin_movilizacion, var_script_case_init, do_ajax_control_buscar_movilizacion_validate_buscar_fecha_fin_movilizacion_cb); }, 200);
  } // do_ajax_control_buscar_movilizacion_validate_buscar_fecha_fin_movilizacion

  function do_ajax_control_buscar_movilizacion_validate_buscar_fecha_fin_movilizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_buscar_movilizacion_validate_buscar_fecha_fin_movilizacion_cb
  // ---------- Form
  function do_ajax_control_buscar_movilizacion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_buscar_movilizacion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_buscar_movilizacion_submit_form(var_buscar_vehiculo_movilizacion, var_buscar_fecha_inicio_movilizacion, var_buscar_fecha_fin_movilizacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_buscar_movilizacion_submit_form_cb);
  } // do_ajax_control_buscar_movilizacion_submit_form

  function do_ajax_control_buscar_movilizacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_control_buscar_movilizacion_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_buscar_movilizacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_buscar_movilizacion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_buscar_movilizacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_buscar_movilizacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_control_buscar_movilizacion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_buscar_movilizacion_navigate_form_cb
  function sc_hide_control_buscar_movilizacion_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_buscar_movilizacion_form
