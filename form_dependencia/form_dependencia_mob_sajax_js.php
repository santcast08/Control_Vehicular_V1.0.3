  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dependencia_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate dependencia_descripcion
  function do_ajax_form_dependencia_mob_validate_dependencia_descripcion()
  {
    var nomeCampo_dependencia_descripcion = "dependencia_descripcion";
    var var_dependencia_descripcion = scAjaxGetFieldText(nomeCampo_dependencia_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dependencia_mob_validate_dependencia_descripcion(var_dependencia_descripcion, var_script_case_init, do_ajax_form_dependencia_mob_validate_dependencia_descripcion_cb);
  } // do_ajax_form_dependencia_mob_validate_dependencia_descripcion

  function do_ajax_form_dependencia_mob_validate_dependencia_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dependencia_descripcion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dependencia_mob_validate_dependencia_descripcion_cb

  // ---------- Validate dependencia_estado
  function do_ajax_form_dependencia_mob_validate_dependencia_estado()
  {
    var nomeCampo_dependencia_estado = "dependencia_estado";
    var var_dependencia_estado = scAjaxGetFieldSelect(nomeCampo_dependencia_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dependencia_mob_validate_dependencia_estado(var_dependencia_estado, var_script_case_init, do_ajax_form_dependencia_mob_validate_dependencia_estado_cb);
  } // do_ajax_form_dependencia_mob_validate_dependencia_estado

  function do_ajax_form_dependencia_mob_validate_dependencia_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dependencia_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dependencia_mob_validate_dependencia_estado_cb
  // ---------- Form
  function do_ajax_form_dependencia_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dependencia_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_dependencia_descripcion = scAjaxGetFieldText("dependencia_descripcion");
    var var_dependencia_estado = scAjaxGetFieldSelect("dependencia_estado");
    var var_iddependencia = scAjaxGetFieldText("iddependencia");
    ...
    scAjaxProcOn();
    x_ajax_form_dependencia_mob_submit_form(var_dependencia_descripcion, var_dependencia_estado, var_iddependencia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dependencia_mob_submit_form_cb);
  } // do_ajax_form_dependencia_mob_submit_form

  function do_ajax_form_dependencia_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("dependencia_descripcion");
      scAjaxHideErrorDisplay("dependencia_estado");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_dependencia_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_dependencia_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("dependencia_descripcion");
    scAjaxHideErrorDisplay("dependencia_estado");
    var var_iddependencia = document.F2.iddependencia.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dependencia_mob_navigate_form(var_iddependencia, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dependencia_mob_navigate_form_cb);
  } // do_ajax_form_dependencia_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dependencia_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dependencia_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_dependencia_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddependencia.value = scAjaxGetKeyValue("iddependencia");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_dependencia_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_dependencia_mob_navigate_form_cb
  function sc_hide_form_dependencia_mob_form()
  {
  ...
  ajax_field_list[0] = "dependencia_descripcion";
  ajax_field_list[1] = "dependencia_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "dependencia_descripcion": {"label": "Dependencia Descripcion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dependencia_estado": {"label": "Dependencia Estado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "dependencia_descripcion": new Array(),
    "dependencia_estado": new Array()
  };
  ajax_field_mult["dependencia_descripcion"][1] = "dependencia_descripcion";
  ajax_field_mult["dependencia_estado"][1] = "dependencia_estado";

  var ajax_field_id = {
    "dependencia_descripcion": new Array("hidden_field_label_dependencia_descripcion", "hidden_field_data_dependencia_descripcion"),
    "dependencia_estado": new Array("hidden_field_label_dependencia_estado", "hidden_field_data_dependencia_estado")
  };

  var ajax_read_only = {
    "dependencia_descripcion": "off",
    "dependencia_estado": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("dependencia_descripcion" == sIndex)
    {
