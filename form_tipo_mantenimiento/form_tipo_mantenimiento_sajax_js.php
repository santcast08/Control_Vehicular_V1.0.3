...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tipo_mantenimiento_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_mantenimiento_submit_form(var_idtipo_mantenimiento, var_tipo, var_tipo_mantenimiento_descripcion, var_tipo_mantenimiento_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_mantenimiento_submit_form_cb);
