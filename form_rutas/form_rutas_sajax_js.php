  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_rutas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_rutas_validate_rutas_origen()
  {
    var nomeCampo_rutas_origen = "rutas_origen";
    var var_rutas_origen = scAjaxGetFieldText(nomeCampo_rutas_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rutas_validate_rutas_origen(var_rutas_origen, var_script_case_init, do_ajax_form_rutas_validate_rutas_origen_cb);
  } // do_ajax_form_rutas_validate_rutas_origen

  function do_ajax_form_rutas_validate_rutas_origen_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rutas_validate_rutas_origen_cb

  // ---------- Validate rutas_destino
  function do_ajax_form_rutas_validate_rutas_destino()
  {
    var nomeCampo_rutas_destino = "rutas_destino";
    var var_rutas_destino = scAjaxGetFieldText(nomeCampo_rutas_destino);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rutas_validate_rutas_destino(var_rutas_destino, var_script_case_init, do_ajax_form_rutas_validate_rutas_destino_cb);
  } // do_ajax_form_rutas_validate_rutas_destino

  function do_ajax_form_rutas_validate_rutas_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rutas_validate_rutas_destino_cb

  // ---------- Validate rutas_distancia
  function do_ajax_form_rutas_validate_rutas_distancia()
  {
    var nomeCampo_rutas_distancia = "rutas_distancia";
    var var_rutas_distancia = scAjaxGetFieldText(nomeCampo_rutas_distancia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rutas_validate_rutas_distancia(var_rutas_distancia, var_script_case_init, do_ajax_form_rutas_validate_rutas_distancia_cb);
  } // do_ajax_form_rutas_validate_rutas_distancia

  function do_ajax_form_rutas_validate_rutas_distancia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rutas_validate_rutas_distancia_cb
  // ---------- Form
  function do_ajax_form_rutas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_rutas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_rutas_submit_form(var_rutas_origen, var_rutas_destino, var_rutas_distancia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_rutas_submit_form_cb);
  } // do_ajax_form_rutas_submit_form

  function do_ajax_form_rutas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_rutas_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_rutas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_rutas_navigate_form(var_id_rutas, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_rutas_navigate_form_cb);
  } // do_ajax_form_rutas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_rutas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_rutas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_rutas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_rutas_navigate_form_cb
  function sc_hide_form_rutas_form()
  {
