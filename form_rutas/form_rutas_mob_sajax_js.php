  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_rutas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate rutas_origen
  function do_ajax_form_rutas_mob_validate_rutas_origen()
  {
    var nomeCampo_rutas_origen = "rutas_origen";
    var var_rutas_origen = scAjaxGetFieldText(nomeCampo_rutas_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rutas_mob_validate_rutas_origen(var_rutas_origen, var_script_case_init, do_ajax_form_rutas_mob_validate_rutas_origen_cb);
  } // do_ajax_form_rutas_mob_validate_rutas_origen

  function do_ajax_form_rutas_mob_validate_rutas_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rutas_origen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rutas_mob_validate_rutas_origen_cb

  // ---------- Validate rutas_destino
  function do_ajax_form_rutas_mob_validate_rutas_destino()
  {
    var nomeCampo_rutas_destino = "rutas_destino";
    var var_rutas_destino = scAjaxGetFieldText(nomeCampo_rutas_destino);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rutas_mob_validate_rutas_destino(var_rutas_destino, var_script_case_init, do_ajax_form_rutas_mob_validate_rutas_destino_cb);
  } // do_ajax_form_rutas_mob_validate_rutas_destino

  function do_ajax_form_rutas_mob_validate_rutas_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rutas_destino";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rutas_mob_validate_rutas_destino_cb

  // ---------- Validate rutas_distancia
  function do_ajax_form_rutas_mob_validate_rutas_distancia()
  {
    var nomeCampo_rutas_distancia = "rutas_distancia";
    var var_rutas_distancia = scAjaxGetFieldText(nomeCampo_rutas_distancia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rutas_mob_validate_rutas_distancia(var_rutas_distancia, var_script_case_init, do_ajax_form_rutas_mob_validate_rutas_distancia_cb);
  } // do_ajax_form_rutas_mob_validate_rutas_distancia

  function do_ajax_form_rutas_mob_validate_rutas_distancia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rutas_distancia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rutas_mob_validate_rutas_distancia_cb
  // ---------- Form
  function do_ajax_form_rutas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_rutas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_rutas_origen = scAjaxGetFieldText("rutas_origen");
    var var_rutas_destino = scAjaxGetFieldText("rutas_destino");
    var var_rutas_distancia = scAjaxGetFieldText("rutas_distancia");
    var var_id_rutas = scAjaxGetFieldText("id_rutas");
    ...
    scAjaxProcOn();
    x_ajax_form_rutas_mob_submit_form(var_rutas_origen, var_rutas_destino, var_rutas_distancia, var_id_rutas, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_rutas_mob_submit_form_cb);
  } // do_ajax_form_rutas_mob_submit_form

  function do_ajax_form_rutas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("rutas_origen");
      scAjaxHideErrorDisplay("rutas_destino");
      scAjaxHideErrorDisplay("rutas_distancia");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_rutas_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_rutas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("rutas_destino");
    scAjaxHideErrorDisplay("rutas_distancia");
    var var_id_rutas = document.F2.id_rutas.value;
    ...
    scAjaxProcOn();
    x_ajax_form_rutas_mob_navigate_form(var_id_rutas, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_rutas_mob_navigate_form_cb);
  } // do_ajax_form_rutas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_rutas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_rutas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_rutas_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_rutas.value = scAjaxGetKeyValue("id_rutas");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_rutas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_rutas_mob_navigate_form_cb
  function sc_hide_form_rutas_mob_form()
  {
  ...
  ajax_field_list[0] = "rutas_origen";
  ajax_field_list[1] = "rutas_destino";
  ajax_field_list[2] = "rutas_distancia";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "rutas_origen": {"label": "Rutas Origen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rutas_destino": {"label": "Rutas Destino", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rutas_distancia": {"label": "Distancia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "rutas_origen": new Array(),
    "rutas_destino": new Array(),
    "rutas_distancia": new Array()
  };
  ajax_field_mult["rutas_origen"][1] = "rutas_origen";
  ajax_field_mult["rutas_destino"][1] = "rutas_destino";
  ajax_field_mult["rutas_distancia"][1] = "rutas_distancia";

  var ajax_field_id = {
    "rutas_origen": new Array("hidden_field_label_rutas_origen", "hidden_field_data_rutas_origen"),
    "rutas_destino": new Array("hidden_field_label_rutas_destino", "hidden_field_data_rutas_destino"),
    "rutas_distancia": new Array("hidden_field_label_rutas_distancia", "hidden_field_data_rutas_distancia")
  };
