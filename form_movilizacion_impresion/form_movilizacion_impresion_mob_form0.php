...
<?php $sStyleHidden_movilizacion_total_km_recorrido_dumb = ('' == $sStyleHidden_movilizacion_total_km_recorrido) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_movilizacion_total_km_recorrido_dumb" style="<?php echo $sStyleHidden_movilizacion_total_km_recorrido_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
