...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dados_form']))
      {
          ...
          if (!isset($this->movilizacion_hora_salida)){$this->movilizacion_hora_salida = $this->nmgp_dados_form['movilizacion_hora_salida'];} 
          if (!isset($this->movilizacion_hora_llegada)){$this->movilizacion_hora_llegada = $this->nmgp_dados_form['movilizacion_hora_llegada'];} 
...
$_SESSION['scriptcase']['form_movilizacion_impresion']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->detalle_movilizacion = $this->detalle_movilizacion_before_qstr;
              ...
              $this->nmgp_refresh_fields = array_diff(array('id_movilizacion', 'movilizacion_fecha', 'idusuario', 'libre', 'idvehiculo', 'movilizacion_funcionario', 'libre2', 'movilizacion_total_combustible', 'movilizacion_km_salida', 'movilizacion_total_galones', 'movilizacion_km_llegada', 'movilizacion_cant_km_adicional', 'movilizacion_recorrido_vehiculo', 'movilizacion_excedente', 'movilizacion_costo_galon', 'movilizacion_total_km_recorrido', 'detalle_movilizacion'), $aDoNotUpdate);
              $this->ajax_return_values();
