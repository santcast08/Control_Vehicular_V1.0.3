 ...
 */
    ...
    session_start();
    $SC_apl_proc = "form_datos_vehiculo_reporte";
/* sc_apl_default */
...
?>
     ...
     parent.nm_gp_export('<?php echo NM_encode_input($opc); ?>', '<?php echo NM_encode_input($target); ?>', cor, parms_pdf, grafico, create, '<?php echo NM_encode_input($export_ajax); ?>', chart_level, page_break, res_cons, use_pass, s_all_cab, s_all_label, s_label_group);return false;
  }
