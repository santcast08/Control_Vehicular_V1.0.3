  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_buscar_vehiculo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate usuario
  function do_ajax_control_buscar_vehiculo_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldSelect(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_buscar_vehiculo_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_control_buscar_vehiculo_mob_validate_usuario_cb);
  } // do_ajax_control_buscar_vehiculo_mob_validate_usuario

  function do_ajax_control_buscar_vehiculo_mob_validate_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_buscar_vehiculo_mob_validate_usuario_cb

  // ---------- Validate tipo_mantenimiento
  function do_ajax_control_buscar_vehiculo_mob_validate_tipo_mantenimiento()
  {
    var nomeCampo_tipo_mantenimiento = "tipo_mantenimiento";
    var var_tipo_mantenimiento = scAjaxGetFieldText(nomeCampo_tipo_mantenimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_control_buscar_vehiculo_mob_validate_tipo_mantenimiento(var_tipo_mantenimiento, var_script_case_init, do_ajax_control_buscar_vehiculo_mob_validate_tipo_mantenimiento_cb); }, 200);
  } // do_ajax_control_buscar_vehiculo_mob_validate_tipo_mantenimiento

  function do_ajax_control_buscar_vehiculo_mob_validate_tipo_mantenimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_mantenimiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_buscar_vehiculo_mob_validate_tipo_mantenimiento_cb

  // ---------- Validate fecha_fin
  function do_ajax_control_buscar_vehiculo_mob_validate_fecha_fin()
  {
    var nomeCampo_fecha_fin = "fecha_fin";
    var var_fecha_fin = scAjaxGetFieldText(nomeCampo_fecha_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_control_buscar_vehiculo_mob_validate_fecha_fin(var_fecha_fin, var_script_case_init, do_ajax_control_buscar_vehiculo_mob_validate_fecha_fin_cb); }, 200);
  } // do_ajax_control_buscar_vehiculo_mob_validate_fecha_fin

  function do_ajax_control_buscar_vehiculo_mob_validate_fecha_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_buscar_vehiculo_mob_validate_fecha_fin_cb
  // ---------- Form
  function do_ajax_control_buscar_vehiculo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_buscar_vehiculo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_usuario = scAjaxGetFieldSelect("usuario");
    var var_tipo_mantenimiento = scAjaxGetFieldText("tipo_mantenimiento");
    ...
    scAjaxProcOn();
    x_ajax_control_buscar_vehiculo_mob_submit_form(var_usuario, var_tipo_mantenimiento, var_fecha_fin, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_buscar_vehiculo_mob_submit_form_cb);
  } // do_ajax_control_buscar_vehiculo_mob_submit_form

  function do_ajax_control_buscar_vehiculo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_control_buscar_vehiculo_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_buscar_vehiculo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_buscar_vehiculo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_buscar_vehiculo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_buscar_vehiculo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_control_buscar_vehiculo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_buscar_vehiculo_mob_navigate_form_cb
  function sc_hide_control_buscar_vehiculo_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_buscar_vehiculo_mob_form
  ...
  ajax_field_list[1] = "tipo_mantenimiento";
  ajax_field_list[2] = "fecha_fin";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "usuario": {"label": "Vehículo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_mantenimiento": {"label": "Fecha:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_fin": {"label": "Hasta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
