  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_funcionarios_excel_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate archivo_funcionario
  function do_ajax_control_funcionarios_excel_mob_validate_archivo_funcionario()
  {
    var nomeCampo_archivo_funcionario = "archivo_funcionario";
    var var_archivo_funcionario = scAjaxGetFieldText(nomeCampo_archivo_funcionario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_funcionarios_excel_mob_validate_archivo_funcionario(var_archivo_funcionario, var_script_case_init, do_ajax_control_funcionarios_excel_mob_validate_archivo_funcionario_cb);
  } // do_ajax_control_funcionarios_excel_mob_validate_archivo_funcionario

  function do_ajax_control_funcionarios_excel_mob_validate_archivo_funcionario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "archivo_funcionario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_funcionarios_excel_mob_validate_archivo_funcionario_cb

  // ---------- Validate ubicacion
  function do_ajax_control_funcionarios_excel_mob_validate_ubicacion()
  {
    var nomeCampo_ubicacion = "ubicacion";
    var var_ubicacion = scAjaxGetFieldText(nomeCampo_ubicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_funcionarios_excel_mob_validate_ubicacion(var_ubicacion, var_script_case_init, do_ajax_control_funcionarios_excel_mob_validate_ubicacion_cb);
  } // do_ajax_control_funcionarios_excel_mob_validate_ubicacion

  function do_ajax_control_funcionarios_excel_mob_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_funcionarios_excel_mob_validate_ubicacion_cb
  // ---------- Form
  function do_ajax_control_funcionarios_excel_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_funcionarios_excel_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_archivo_funcionario = scAjaxGetFieldText("archivo_funcionario");
    var var_ubicacion = scAjaxGetFieldText("ubicacion");
    var var_archivo_funcionario_ul_name = scAjaxSpecCharProtect(document.F1.archivo_funcionario_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_archivo_funcionario_ul_type = document.F1.archivo_funcionario_ul_type.value;
    var var_archivo_funcionario_salva = scAjaxSpecCharProtect(document.F1.archivo_funcionario_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_archivo_funcionario_limpa = document.F1.archivo_funcionario_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_control_funcionarios_excel_mob_submit_form(var_archivo_funcionario, var_ubicacion, var_archivo_funcionario_ul_name, var_archivo_funcionario_ul_type, var_archivo_funcionario_salva, var_archivo_funcionario_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_funcionarios_excel_mob_submit_form_cb);
  } // do_ajax_control_funcionarios_excel_mob_submit_form

  function do_ajax_control_funcionarios_excel_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.archivo_funcionario_limpa && document.F1.archivo_funcionario_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("archivo_funcionario", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_archivo_funcionario") && "" != document.getElementById("id_ajax_doc_archivo_funcionario").innerHTML)
      {
        document.getElementById("id_ajax_doc_archivo_funcionario").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
  ...
  } // do_ajax_control_funcionarios_excel_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_funcionarios_excel_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_funcionarios_excel_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_funcionarios_excel_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_funcionarios_excel_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_control_funcionarios_excel_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_funcionarios_excel_mob_navigate_form_cb
  function sc_hide_control_funcionarios_excel_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_funcionarios_excel_mob_form
  ...
  ajax_field_list[0] = "archivo_funcionario";
  ajax_field_list[1] = "ubicacion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "archivo_funcionario": {"label": "Archivo Excel", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "archivo_funcionario": new Array(),
    "ubicacion": new Array()
  };
  ajax_field_mult["archivo_funcionario"][1] = "archivo_funcionario";
  ajax_field_mult["ubicacion"][1] = "ubicacion";

  var ajax_field_id = {
    "archivo_funcionario": new Array("hidden_field_label_archivo_funcionario", "hidden_field_data_archivo_funcionario")
  };

  var ajax_read_only = {
    "archivo_funcionario": "off",
    "ubicacion": "off"
  };
