...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " vehiculos"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " vehiculos"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_movilizacion_reporte/form_movilizacion_reporte_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_movilizacion_reporte_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_movilizacion_reporte_mob_jquery.php');
 ...
 function toggleBlock(e) {
  ...
  if (show_block[block_id]) {
    if ("hidden_bloco_1" == block_id) {
      scAjaxDetailHeight("grid_movilizacion_impresion", $($("#nmsc_iframe_liga_grid_movilizacion_impresion")[0].contentWindow.document).innerHeight());
    }
  }
 }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['recarga'];
}
?>
<body class="scFormPage" style="<?php echo $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_movilizacion_reporte']['error_buffer']) && '' != $_SESSION['scriptcase']['form_movilizacion_reporte']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_movilizacion_reporte']['error_buffer'];
}
...
<?php
 include_once("form_movilizacion_reporte_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_movilizacion_reporte_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_movilizacion_reporte_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_movilizacion_reporte_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<table width="100%" height="67px" class="scFormHeader">
        ...
        <td width="67px" class="scFormHeaderFont"><IMG SRC="<?php echo $this->Ini->path_imag_cab ?>/sys__NM__img__NM__LOGOTIPO AME 2013 16.png" BORDER="0"/></td>
               <td class="scFormHeaderFont"><span id="lin1_col1"><?php echo "Control Vehicular" ?></span><br /><span id="lin2_col1"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " vehiculos"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " vehiculos"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<span id="id_read_on_vehiculo_km_galon" class="sc-ui-readonly-vehiculo_km_galon css_vehiculo_km_galon_line" style="<?php echo $sStyleReadLab_vehiculo_km_galon; ?>"><?php echo $this->form_encode_input($this->vehiculo_km_galon); ?></span><span id="id_read_off_vehiculo_km_galon" style="white-space: nowrap;<?php echo $sStyleReadInp_vehiculo_km_galon; ?>">
 ...
 size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['vehiculo_km_galon']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['vehiculo_km_galon']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['vehiculo_km_galon']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['detalle_movilizacion_reporte']))
    {
        $this->nm_new_label['detalle_movilizacion_reporte'] = "detalle_movilizacion_reporte";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $detalle_movilizacion_reporte = $this->detalle_movilizacion_reporte;
   $sStyleHidden_detalle_movilizacion_reporte = '';
   if (isset($this->nmgp_cmp_hidden['detalle_movilizacion_reporte']) && $this->nmgp_cmp_hidden['detalle_movilizacion_reporte'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['detalle_movilizacion_reporte']);
       $sStyleHidden_detalle_movilizacion_reporte = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_detalle_movilizacion_reporte = 'display: none;';
   $sStyleReadInp_detalle_movilizacion_reporte = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['detalle_movilizacion_reporte']) && $this->nmgp_cmp_readonly['detalle_movilizacion_reporte'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['detalle_movilizacion_reporte']);
       $sStyleReadLab_detalle_movilizacion_reporte = '';
       $sStyleReadInp_detalle_movilizacion_reporte = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['detalle_movilizacion_reporte']) && $this->nmgp_cmp_hidden['detalle_movilizacion_reporte'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="detalle_movilizacion_reporte" value="<?php echo $this->form_encode_input($detalle_movilizacion_reporte) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_detalle_movilizacion_reporte_line" id="hidden_field_data_detalle_movilizacion_reporte" style="<?php echo $sStyleHidden_detalle_movilizacion_reporte; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_detalle_movilizacion_reporte_line" style="vertical-align: top;padding: 0px">
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['grid_movilizacion_impresion_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['grid_movilizacion_impresion_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_movilizacion_impresion"]) && $this->Ini->sc_lig_md5["grid_movilizacion_impresion"] == "S") {
     $Parms_Lig  = "SC_glo_par_movilizacion_fecha_inicio*scinmovilizacion_fecha_inicio*scoutSC_glo_par_movilizacion_fecha_fin*scinmovilizacion_fecha_fin*scoutSC_glo_par_idvehiculo_reporte_movilizacion*scinIdVehiculo_reporte_movilizacion*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout";
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_movilizacion_reporte_mob@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
     $Md5_Lig  = "SC_glo_par_movilizacion_fecha_inicio*scinmovilizacion_fecha_inicio*scoutSC_glo_par_movilizacion_fecha_fin*scinmovilizacion_fecha_fin*scoutSC_glo_par_idvehiculo_reporte_movilizacion*scinIdVehiculo_reporte_movilizacion*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout";
 }
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_movilizacion_reporte_mob_empty.htm' : $this->Ini->link_grid_movilizacion_impresion_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte']) && 'nmsc_iframe_liga_grid_movilizacion_impresion' != $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['grid_movilizacion_impresion_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
    scOpenMasterDetail("<?php echo $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte'] ?>", "<?php echo $sDetailSrc; ?>");
});
</script>
<?php
}
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_grid_movilizacion_impresion"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_grid_movilizacion_impresion"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_detalle_movilizacion_reporte_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_detalle_movilizacion_reporte_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_movilizacion_reporte_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_movilizacion_reporte_mob");
 parent.scAjaxDetailHeight("form_movilizacion_reporte_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_pdf() {
		if ($("#sc_b_pdf_t.sc-unique-btn-1").length && $("#sc_b_pdf_t.sc-unique-btn-1").is(":visible")) {
			tb_show('', "<?php echo  $this->Ini->path_link . SC_dir_app_name('form_movilizacion_reporte')  ?>/form_movilizacion_reporte_config_pdf.php?nm_opc=pdf&nm_target=2&nm_cor=cor&papel=8&lpapel=0&apapel=0&orientacao=1&bookmarks=XX&largura=800&conf_larg=10&conf_fonte=N&grafico=XX&language=es&conf_socor=N&KeepThis=true&TB_iframe=true&modal=true");
			 return;
		}
	}
