...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['embutida_pdf']))
 {
 ?>
<?php
...
<?php
include_once("form_movilizacion_reporte_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_movilizacion_reporte_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['recarga'];
}
?>
...
<?php
 include_once("form_movilizacion_reporte_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_movilizacion_reporte'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_movilizacion_reporte'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['grid_movilizacion_impresion_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion_reporte'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['grid_movilizacion_impresion_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_movilizacion_impresion"]) && $this->Ini->sc_lig_md5["grid_movilizacion_impresion"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_movilizacion_reporte@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_movilizacion_reporte_empty.htm' : $this->Ini->link_grid_movilizacion_impresion_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['pdf_view'])
 {
     $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['grid_movilizacion_impresion_script_case_init'] ]['grid_movilizacion_impresion']['embutida_pdf'] = true;
     $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_movilizacion_impresion'] = $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['grid_movilizacion_impresion_script_case_init'] ]['grid_movilizacion_impresion']['embutida_form_parms'] . '?#?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '?@??#?script_case_session=' . session_id() . '?@??#?script_case_detail=Y?@?';
     include_once ($this->Ini->root . $this->Ini->link_grid_movilizacion_impresion_cons . "index.php");
     $this->grid_movilizacion_impresion_pdf_det = new grid_movilizacion_impresion_apl;
     if (method_exists($this->grid_movilizacion_impresion_pdf_det, "controle"))
     {
         $this->grid_movilizacion_impresion_pdf_det->controle();
     }
     unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['grid_movilizacion_impresion_script_case_init'] ]['grid_movilizacion_impresion']['embutida_pdf']);
     unset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_movilizacion_impresion']);
 }
 else
 {
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_reporte']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_movilizacion_reporte");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_movilizacion_reporte");
 parent.scAjaxDetailHeight("form_movilizacion_reporte", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
