...
function lookup_idvehiculo(campo)
{
   ...
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_movilizacion_mob')?>/form_movilizacion_mob.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php echo session_id() ?>&nmgp_opcao=lookup", recebe_idvehiculo, "idvehiculo", dados, false);
}
