...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_movilizacion_hora_salida_hora' + iSeqRow).bind('blur', function() { sc_form_movilizacion_movilizacion_hora_salida_onblur(this, iSeqRow) })
                                                           .bind('focus', function() { sc_form_movilizacion_movilizacion_hora_salida_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_movilizacion_hora_llegada_hora' + iSeqRow).bind('blur', function() { sc_form_movilizacion_movilizacion_hora_llegada_onblur(this, iSeqRow) })
                                                            .bind('focus', function() { sc_form_movilizacion_movilizacion_hora_llegada_onfocus(this, iSeqRow) });
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_movilizacion_hora_salida" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movilizacion_mob_validate_movilizacion_hora_salida(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#id_sc_field_movilizacion_hora_llegada" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movilizacion_mob_validate_movilizacion_hora_llegada(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
