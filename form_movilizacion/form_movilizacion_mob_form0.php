...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_libre2_line" id="hidden_field_data_libre2" style="<?php echo $sStyleHidden_libre2; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_libre2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_libre2_label"><span id="id_label_libre2"><?php echo $this->nm_new_label['libre2']; ?></span></span><br><span id="id_read_on_libre2 css_libre2_line" style="<?php echo $sStyleReadLab_libre2; ?>"><?php echo $this->form_encode_input($this->libre2); ?></span><span id="id_read_off_libre2" style="<?php echo $sStyleReadInp_libre2; ?>"><span id="id_ajax_label_libre2"><?php echo $libre2?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_ruta_line" id="hidden_field_data_movilizacion_ruta" style="<?php echo $sStyleHidden_movilizacion_ruta; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_ruta_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_ruta_label"><span id="id_label_movilizacion_ruta"><?php echo $this->nm_new_label['movilizacion_ruta']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_ruta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_ruta'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_movilizacion_ruta_dumb = ('' == $sStyleHidden_movilizacion_ruta) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_movilizacion_ruta_dumb" style="<?php echo $sStyleHidden_movilizacion_ruta_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<span id="id_read_on_movilizacion_hora_salida" class="sc-ui-readonly-movilizacion_hora_salida css_movilizacion_hora_salida_line" style="<?php echo $sStyleReadLab_movilizacion_hora_salida; ?>"><?php echo $this->form_encode_input($movilizacion_hora_salida); ?></span><span id="id_read_off_movilizacion_hora_salida" style="white-space: nowrap;<?php echo $sStyleReadInp_movilizacion_hora_salida; ?>">
 ...
 size=8 alt="{datatype: 'date', dateSep: '<?php echo $this->field_config['movilizacion_hora_salida']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['movilizacion_hora_salida']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ ', timeSep: '<?php echo $this->field_config['movilizacion_hora_salida_hora']['time_sep']; ?>', timeFormat: '<?php echo $this->field_config['movilizacion_hora_salida_hora']['date_format']; ?>'}" ><?php
...
<span id="id_read_on_movilizacion_hora_llegada" class="sc-ui-readonly-movilizacion_hora_llegada css_movilizacion_hora_llegada_line" style="<?php echo $sStyleReadLab_movilizacion_hora_llegada; ?>"><?php echo $this->form_encode_input($movilizacion_hora_llegada); ?></span><span id="id_read_off_movilizacion_hora_llegada" style="white-space: nowrap;<?php echo $sStyleReadInp_movilizacion_hora_llegada; ?>">
 ...
 size=8 alt="{datatype: 'date', dateSep: '<?php echo $this->field_config['movilizacion_hora_llegada']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['movilizacion_hora_llegada']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ ', timeSep: '<?php echo $this->field_config['movilizacion_hora_llegada_hora']['time_sep']; ?>', timeFormat: '<?php echo $this->field_config['movilizacion_hora_llegada_hora']['date_format']; ?>'}" ><?php
