...
class form_movilizacion_mob_apl
{
   ...
   var $movilizacion_hora_salida_hora;
   var $movilizacion_hora_llegada;
   var $movilizacion_hora_llegada_hora;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['libre2']))
          {
              $this->libre2 = $this->NM_ajax_info['param']['libre2'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['movilizacion_hora_llegada_hora']))
          {
              $this->movilizacion_hora_llegada_hora = $this->NM_ajax_info['param']['movilizacion_hora_llegada_hora'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['movilizacion_hora_salida_hora']))
          {
              $this->movilizacion_hora_salida_hora = $this->NM_ajax_info['param']['movilizacion_hora_salida_hora'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['movilizacion_ruta']))
          {
              $this->movilizacion_ruta = $this->NM_ajax_info['param']['movilizacion_ruta'];
          }
...
//
      ...
      if (isset($this->movilizacion_ruta)) { $this->nm_limpa_alfa($this->movilizacion_ruta); }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['movilizacion_hora_salida']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'] . ';' . $_SESSION['scriptcase']['reg_conf']['time_format'];
      $this->field_config['movilizacion_hora_salida']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['movilizacion_hora_salida']['time_sep']     = $_SESSION['scriptcase']['reg_conf']['time_sep'];
      $this->field_config['movilizacion_hora_salida']['date_display'] = "ddmmaaaa;hhii";
      $this->new_date_format('DH', 'movilizacion_hora_salida');
      ...
      $this->field_config['movilizacion_hora_llegada']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'] . ';' . $_SESSION['scriptcase']['reg_conf']['time_format'];
      $this->field_config['movilizacion_hora_llegada']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['movilizacion_hora_llegada']['time_sep']     = $_SESSION['scriptcase']['reg_conf']['time_sep'];
      $this->field_config['movilizacion_hora_llegada']['date_display'] = "ddmmaaaa;hhii";
      $this->new_date_format('DH', 'movilizacion_hora_llegada');
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_movilizacion_ruta' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'movilizacion_ruta');
          }
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'movilizacion_ruta':
               return "Ciudad de Destino Final";
               break;
           ...
           case 'movilizacion_total_km_recorrido':
               return "Total de Kilometraje Real Recorrido";
               break;
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ('' == $filtro || 'movilizacion_ruta' == $filtro)
        $this->ValidateField_movilizacion_ruta($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    function ValidateField_id_movilizacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Numero de Movilización: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $Campos_Crit .= "Numero de Movilización; " ; 
                  if (!isset($Campos_Erros['id_movilizacion']))
                  {
                      $Campos_Erros['id_movilizacion'] = array();
                  }
    ...
    function ValidateField_movilizacion_ruta(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_ruta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_ruta'] == "on")) 
      { 
          if ($this->movilizacion_ruta == "")  
          { 
              $Campos_Falta[] =  "Ciudad de Destino Final" ; 
              if (!isset($Campos_Erros['movilizacion_ruta']))
              {
                  $Campos_Erros['movilizacion_ruta'] = array();
              }
              $Campos_Erros['movilizacion_ruta'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['movilizacion_ruta']) || !is_array($this->NM_ajax_info['errList']['movilizacion_ruta']))
                  {
                      $this->NM_ajax_info['errList']['movilizacion_ruta'] = array();
                  }
                  $this->NM_ajax_info['errList']['movilizacion_ruta'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->movilizacion_ruta) > 300) 
          { 
              $Campos_Crit .= "Ciudad de Destino Final " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['movilizacion_ruta']))
              {
                  $Campos_Erros['movilizacion_ruta'] = array();
              }
              $Campos_Erros['movilizacion_ruta'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['movilizacion_ruta']) || !is_array($this->NM_ajax_info['errList']['movilizacion_ruta']))
              {
                  $this->NM_ajax_info['errList']['movilizacion_ruta'] = array();
              }
              $this->NM_ajax_info['errList']['movilizacion_ruta'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_movilizacion_ruta
    ...
    {
        global $teste_validade;
      nm_limpa_data($this->movilizacion_hora_salida, $this->field_config['movilizacion_hora_salida']['date_sep']) ; 
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $guarda_datahora = $this->field_config['movilizacion_hora_salida']['date_format']; 
          if (false !== strpos($guarda_datahora, ';')) $this->field_config['movilizacion_hora_salida']['date_format'] = substr($guarda_datahora, 0, strpos($guarda_datahora, ';'));
          $Format_Data = $this->field_config['movilizacion_hora_salida']['date_format']; 
          nm_limpa_data($Format_Data, $this->field_config['movilizacion_hora_salida']['date_sep']) ; 
          if (trim($this->movilizacion_hora_salida) != "")  
          { 
              if ($teste_validade->Data($this->movilizacion_hora_salida, $Format_Data, $trab_dt_min, $trab_dt_max) == false)  
              { 
                  $Campos_Crit .= "Fecha y Hora de Salida; " ; 
          ...
          $this->field_config['movilizacion_hora_salida']['date_format'] = $guarda_datahora; 
       } 
      nm_limpa_hora($this->movilizacion_hora_salida_hora, $this->field_config['movilizacion_hora_salida_hora']['time_sep']) ; 
      if ($this->nmgp_opcao != "excluir") 
      {
          $Format_Hora = $this->field_config['movilizacion_hora_salida_hora']['date_format']; 
          nm_limpa_hora($Format_Hora, $this->field_config['movilizacion_hora_salida_hora']['time_sep']) ; 
          if (trim($this->movilizacion_hora_salida_hora) != "")  
          { 
              if ($teste_validade->Hora($this->movilizacion_hora_salida_hora, $Format_Hora) == false)  
              { 
                  $Campos_Crit .= "Fecha y Hora de Salida; " ; 
                  if (!isset($Campos_Erros['movilizacion_hora_salida_hora']))
                  {
                      $Campos_Erros['movilizacion_hora_salida_hora'] = array();
                  }
                  $Campos_Erros['movilizacion_hora_salida_hora'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['movilizacion_hora_salida']) || !is_array($this->NM_ajax_info['errList']['movilizacion_hora_salida']))
                  {
                      $this->NM_ajax_info['errList']['movilizacion_hora_salida'] = array();
                  }
    ...
    } // ValidateField_movilizacion_hora_salida_hora
    ...
    {
        global $teste_validade;
      nm_limpa_data($this->movilizacion_hora_llegada, $this->field_config['movilizacion_hora_llegada']['date_sep']) ; 
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $guarda_datahora = $this->field_config['movilizacion_hora_llegada']['date_format']; 
          if (false !== strpos($guarda_datahora, ';')) $this->field_config['movilizacion_hora_llegada']['date_format'] = substr($guarda_datahora, 0, strpos($guarda_datahora, ';'));
          $Format_Data = $this->field_config['movilizacion_hora_llegada']['date_format']; 
          nm_limpa_data($Format_Data, $this->field_config['movilizacion_hora_llegada']['date_sep']) ; 
          if (trim($this->movilizacion_hora_llegada) != "")  
          { 
              if ($teste_validade->Data($this->movilizacion_hora_llegada, $Format_Data, $trab_dt_min, $trab_dt_max) == false)  
              { 
                  $Campos_Crit .= "Fecha y Hora de Llegada; " ; 
          ...
          $this->field_config['movilizacion_hora_llegada']['date_format'] = $guarda_datahora; 
       } 
      nm_limpa_hora($this->movilizacion_hora_llegada_hora, $this->field_config['movilizacion_hora_llegada_hora']['time_sep']) ; 
      if ($this->nmgp_opcao != "excluir") 
      {
          $Format_Hora = $this->field_config['movilizacion_hora_llegada_hora']['date_format']; 
          nm_limpa_hora($Format_Hora, $this->field_config['movilizacion_hora_llegada_hora']['time_sep']) ; 
          if (trim($this->movilizacion_hora_llegada_hora) != "")  
          { 
              if ($teste_validade->Hora($this->movilizacion_hora_llegada_hora, $Format_Hora) == false)  
              { 
                  $Campos_Crit .= "Fecha y Hora de Llegada; " ; 
                  if (!isset($Campos_Erros['movilizacion_hora_llegada_hora']))
                  {
                      $Campos_Erros['movilizacion_hora_llegada_hora'] = array();
                  }
                  $Campos_Erros['movilizacion_hora_llegada_hora'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['movilizacion_hora_llegada']) || !is_array($this->NM_ajax_info['errList']['movilizacion_hora_llegada']))
                  {
                      $this->NM_ajax_info['errList']['movilizacion_hora_llegada'] = array();
                  }
    ...
    } // ValidateField_movilizacion_hora_llegada_hora
    ...
    function ValidateField_movilizacion_total_galones(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Total de Galones Consumidos: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $Campos_Crit .= "Total de Galones Consumidos; " ; 
                  if (!isset($Campos_Erros['movilizacion_total_galones']))
                  {
                      $Campos_Erros['movilizacion_total_galones'] = array();
                  }
    ...
    function ValidateField_movilizacion_km_salida(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Kilometraje de Salida del Vehículo: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $Campos_Crit .= "Kilometraje de Salida del Vehículo; " ; 
                  if (!isset($Campos_Erros['movilizacion_km_salida']))
                  {
                      $Campos_Erros['movilizacion_km_salida'] = array();
                  }
    ...
    function ValidateField_movilizacion_km_llegada(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Kilometraje de Llegada del Vehículo: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $Campos_Crit .= "Kilometraje de Llegada del Vehículo; " ; 
                  if (!isset($Campos_Erros['movilizacion_km_llegada']))
                  {
                      $Campos_Erros['movilizacion_km_llegada'] = array();
                  }
    ...
    function ValidateField_movilizacion_total_km_recorrido(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Total de Kilometraje Real Recorrido: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $Campos_Crit .= "Total de Kilometraje Real Recorrido; " ; 
                  if (!isset($Campos_Erros['movilizacion_total_km_recorrido']))
                  {
                      $Campos_Erros['movilizacion_total_km_recorrido'] = array();
                  }
   ...
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->idvehiculo, $this->field_config['idvehiculo']['symbol_grp']) ; 
      nm_limpa_data($this->movilizacion_hora_salida, $this->field_config['movilizacion_hora_salida']['date_sep']) ; 
      nm_limpa_hora($this->movilizacion_hora_salida_hora, $this->field_config['movilizacion_hora_salida']['time_sep']) ; 
      if (!empty($this->field_config['movilizacion_total_combustible']['symbol_dec']))
      {
         $this->sc_remove_currency($this->movilizacion_total_combustible, $this->field_config['movilizacion_total_combustible']['symbol_dec'], $this->field_config['movilizacion_total_combustible']['symbol_grp'], $this->field_config['movilizacion_total_combustible']['symbol_mon']);
         nm_limpa_valor($this->movilizacion_total_combustible, $this->field_config['movilizacion_total_combustible']['symbol_dec'], $this->field_config['movilizacion_total_combustible']['symbol_grp']);
      ...
      nm_limpa_data($this->movilizacion_hora_llegada, $this->field_config['movilizacion_hora_llegada']['date_sep']) ; 
      nm_limpa_hora($this->movilizacion_hora_llegada_hora, $this->field_config['movilizacion_hora_llegada']['time_sep']) ; 
      if (!empty($this->field_config['movilizacion_total_galones']['symbol_dec']))
      {
         $this->sc_remove_currency($this->movilizacion_total_galones, $this->field_config['movilizacion_total_galones']['symbol_dec'], $this->field_config['movilizacion_total_galones']['symbol_grp'], $this->field_config['movilizacion_total_galones']['symbol_mon']);
         nm_limpa_valor($this->movilizacion_total_galones, $this->field_config['movilizacion_total_galones']['symbol_dec'], $this->field_config['movilizacion_total_galones']['symbol_grp']);
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      {
          $nm_separa_data = strpos($this->field_config['movilizacion_hora_salida']['date_format'], ";") ;
          $guarda_format_hora = $this->field_config['movilizacion_hora_salida']['date_format'];
          $this->field_config['movilizacion_hora_salida']['date_format'] = substr($this->field_config['movilizacion_hora_salida']['date_format'], 0, $nm_separa_data) ;
          $separador = strpos($this->movilizacion_hora_salida, " ") ; 
          $this->movilizacion_hora_salida_hora = substr($this->movilizacion_hora_salida, $separador + 1) ; 
          $this->movilizacion_hora_salida = substr($this->movilizacion_hora_salida, 0, $separador) ; 
          nm_volta_data($this->movilizacion_hora_salida, $this->field_config['movilizacion_hora_salida']['date_format']) ; 
          nmgp_Form_Datas($this->movilizacion_hora_salida, $this->field_config['movilizacion_hora_salida']['date_format'], $this->field_config['movilizacion_hora_salida']['date_sep']) ;  
          $this->field_config['movilizacion_hora_salida']['date_format'] = substr($guarda_format_hora, $nm_separa_data + 1) ;
          nm_volta_hora($this->movilizacion_hora_salida_hora, $this->field_config['movilizacion_hora_salida']['date_format']) ; 
          nmgp_Form_Hora($this->movilizacion_hora_salida_hora, $this->field_config['movilizacion_hora_salida']['date_format'], $this->field_config['movilizacion_hora_salida']['time_sep']) ;  
      ...
      {
          $nm_separa_data = strpos($this->field_config['movilizacion_hora_llegada']['date_format'], ";") ;
          $guarda_format_hora = $this->field_config['movilizacion_hora_llegada']['date_format'];
          $this->field_config['movilizacion_hora_llegada']['date_format'] = substr($this->field_config['movilizacion_hora_llegada']['date_format'], 0, $nm_separa_data) ;
          $separador = strpos($this->movilizacion_hora_llegada, " ") ; 
          $this->movilizacion_hora_llegada_hora = substr($this->movilizacion_hora_llegada, $separador + 1) ; 
          $this->movilizacion_hora_llegada = substr($this->movilizacion_hora_llegada, 0, $separador) ; 
          nm_volta_data($this->movilizacion_hora_llegada, $this->field_config['movilizacion_hora_llegada']['date_format']) ; 
          nmgp_Form_Datas($this->movilizacion_hora_llegada, $this->field_config['movilizacion_hora_llegada']['date_format'], $this->field_config['movilizacion_hora_llegada']['date_sep']) ;  
          $this->field_config['movilizacion_hora_llegada']['date_format'] = substr($guarda_format_hora, $nm_separa_data + 1) ;
          nm_volta_hora($this->movilizacion_hora_llegada_hora, $this->field_config['movilizacion_hora_llegada']['date_format']) ; 
          nmgp_Form_Hora($this->movilizacion_hora_llegada_hora, $this->field_config['movilizacion_hora_llegada']['date_format'], $this->field_config['movilizacion_hora_llegada']['time_sep']) ;  
      ...
      if ('' !== $this->movilizacion_costo_galon || (!empty($format_fields) && isset($format_fields['movilizacion_costo_galon'])))
      {
          ...
          $sMonSymb = $this->field_config['movilizacion_costo_galon']['symbol_mon'];
          $this->sc_add_currency($this->movilizacion_costo_galon, $sMonSymb, $this->field_config['movilizacion_costo_galon']['format_pos']); 
      }
   }
...
//-- 
   function nm_converte_datas($use_null = true, $bForce = false)
   {
      ...
      { 
          $nm_separa_data = strpos($this->field_config['movilizacion_hora_salida']['date_format'], ";") ;
          $this->field_config['movilizacion_hora_salida']['date_format'] = substr($this->field_config['movilizacion_hora_salida']['date_format'], 0, $nm_separa_data) ;
          nm_conv_data($this->movilizacion_hora_salida, $this->field_config['movilizacion_hora_salida']['date_format']) ; 
          ...
          if ($this->movilizacion_hora_salida_hora == "" )  
          { 
              $this->movilizacion_hora_salida_hora = "00:00:00:000" ; 
          }
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
          {
              $this->movilizacion_hora_salida_hora = substr($this->movilizacion_hora_salida_hora, 0, -4) . "." . substr($this->movilizacion_hora_salida_hora, -3);
          }
      ...
      { 
          $nm_separa_data = strpos($this->field_config['movilizacion_hora_llegada']['date_format'], ";") ;
          $this->field_config['movilizacion_hora_llegada']['date_format'] = substr($this->field_config['movilizacion_hora_llegada']['date_format'], 0, $nm_separa_data) ;
          nm_conv_data($this->movilizacion_hora_llegada, $this->field_config['movilizacion_hora_llegada']['date_format']) ; 
          if ('pdo_sqlsrv' == strtolower($this->Ini->nm_tpbanco) || 'pdo_dblib' == strtolower($this->Ini->nm_tpbanco))
          {
          ...
          if ($this->movilizacion_hora_llegada_hora == "" )  
          { 
              $this->movilizacion_hora_llegada_hora = "00:00:00:000" ; 
          }
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
          {
              $this->movilizacion_hora_llegada_hora = substr($this->movilizacion_hora_llegada_hora, 0, -4) . "." . substr($this->movilizacion_hora_llegada_hora, -3);
          }
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          {
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_libre2();
          $this->ajax_return_values_movilizacion_ruta();
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario'][] = '';
   ...
   function ajax_return_values_idvehiculo($bForce = false)
   {
          ...
          //----- libre2
   function ajax_return_values_libre2($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("libre2", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->libre2);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['libre2'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- movilizacion_ruta
   function ajax_return_values_movilizacion_ruta($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("movilizacion_ruta", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->movilizacion_ruta);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['movilizacion_ruta'] = array(
                       'row'    => '',
               'type'    => 'text',
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_movilizacion_funcionario'][] = '';
   ...
   function ajax_return_values_movilizacion_hora_salida($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['movilizacion_hora_salida_hora'] = array(
               'type'    => 'text',
               'valList' => array($this->movilizacion_hora_salida_hora),
              );
          }
   }
   ...
   function ajax_return_values_movilizacion_hora_llegada($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['movilizacion_hora_llegada_hora'] = array(
               'type'    => 'text',
               'valList' => array($this->movilizacion_hora_llegada_hora),
              );
          }
   }
...
$_SESSION['scriptcase']['form_movilizacion_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET IdVehiculo = $this->idvehiculo, idusuario = $this->idusuario, movilizacion_funcionario = '$this->movilizacion_funcionario', Movilizacion_Fecha = EXTEND('$this->movilizacion_fecha', YEAR TO DAY), Movilizacion_Ruta = '$this->movilizacion_ruta', Movilizacion_Hora_Salida = " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", Movilizacion_Hora_Llegada = " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", Movilizacion_Km_Salida = $this->movilizacion_km_salida, Movilizacion_Km_Llegada = $this->movilizacion_km_llegada, Movilizacion_Costo_Galon = $this->movilizacion_costo_galon, movilizacion_cant_km_adicional = $this->movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido = $this->movilizacion_total_km_recorrido, movilizacion_Recorrido_Vehiculo = $this->movilizacion_recorrido_vehiculo, movilizacion_Excedente = $this->movilizacion_excedente, Movilizacion_Total_Galones = $this->movilizacion_total_galones, movilizacion_total_combustible = $this->movilizacion_total_combustible";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET IdVehiculo = $this->idvehiculo, idusuario = $this->idusuario, movilizacion_funcionario = '$this->movilizacion_funcionario', Movilizacion_Fecha = " . $this->Ini->date_delim . $this->movilizacion_fecha . $this->Ini->date_delim1 . ", Movilizacion_Ruta = '$this->movilizacion_ruta', Movilizacion_Hora_Salida = " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", Movilizacion_Hora_Llegada = " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", Movilizacion_Km_Salida = $this->movilizacion_km_salida, Movilizacion_Km_Llegada = $this->movilizacion_km_llegada, Movilizacion_Costo_Galon = $this->movilizacion_costo_galon, movilizacion_cant_km_adicional = $this->movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido = $this->movilizacion_total_km_recorrido, movilizacion_Recorrido_Vehiculo = $this->movilizacion_recorrido_vehiculo, movilizacion_Excedente = $this->movilizacion_excedente, Movilizacion_Total_Galones = $this->movilizacion_total_galones, movilizacion_total_combustible = $this->movilizacion_total_combustible";  
          ...
          $this->detalle_movilizacion = $this->detalle_movilizacion_before_qstr;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['movilizacion_ruta'])) { $this->movilizacion_ruta = $NM_val_form['movilizacion_ruta']; }
              elseif (isset($this->movilizacion_ruta)) { $this->nm_limpa_alfa($this->movilizacion_ruta); }
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              {
                  if (!$this->form_detalle_movilizacion_mob->deletaRegistros($sDetailWhere))
                  {
                      $bDelecaoOk = false;
...
<?php
    ...
    $this->movilizacion_hora_llegada_Dt_min = "'0000" . substr($this->movilizacion_hora_llegada_Dt_min, 4) . "'"; 
    $this->movilizacion_hora_llegada_Dt_max = "'0000" . substr($this->movilizacion_hora_llegada_Dt_max, 4) . "'"; 
        $this->initFormPages();
