...
//---
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['php_cmp_required']['movilizacion_ruta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['php_cmp_required']['movilizacion_ruta'] == "on")) 
      { 
...
$_SESSION['scriptcase']['form_movilizacion']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              {
                  if (!$this->form_detalle_movilizacion->deletaRegistros($sDetailWhere))
                  {
                      $bDelecaoOk = false;
