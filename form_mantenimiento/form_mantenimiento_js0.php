<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idmantenimiento" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idmantenimiento']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_mantenimiento']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_mantenimiento"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mantenimiento']['where_detal']))
  {
?>  
...
{
    window.open('<?php echo $this->Ini->path_link . "" . SC_dir_app_name('form_mantenimiento') . "/form_mantenimiento_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . $this->form_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id();?>"&apl_prt=form_mantenimiento.php&opcao=print&cor_print=CO','','location=no,menubar,resizable,scrollbars,status=no,toolbar');
}
...
function lookup_idvehiculo(campo)
{
   ...
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_mantenimiento')?>/form_mantenimiento.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php echo session_id() ?>&nmgp_opcao=lookup", recebe_idvehiculo, "idvehiculo", dados, false);
}
